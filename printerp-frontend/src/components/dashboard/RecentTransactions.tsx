...
const RecentTransactions = () => {
  return (
    <DashboardCard title="Ultimas Requisições">
      <>
        <Timeline
        ...
        >
          ...
          <TimelineItem>
            <TimelineOppositeContent>10/07/2024</TimelineOppositeContent>
            <TimelineSeparator>
            ...
            <TimelineContent>
              <Typography>
                Requisição de ROGERIO para BANHEIRA SM 74 SM 102. Total R$ 35,14
              </Typography>{" "}
